...
const Course: React.FC<CourseProps> = ({
  ...
  return (
   <>
   {
    !isUserEnrolled ? <section className="sm:flex-shrink-0 sm:w-full sm:h-72 lg:h-80  lg:w-full   lg:h-48 border border-neutral-200 bg-white rounded-md p-1 sm:flex sm:flex-col sm:shadow-sm">
    {imageurl ? (
      <img
        src={imageurl}
    ...
    <div className="mt-2 flex-grow">
      ...
      <h1 className="line-clamp-3 text-muted-foreground text-xs mt-1">
        {description}
      </h1>
      {isUserEnrolled && (
        <div className="mt-2">
