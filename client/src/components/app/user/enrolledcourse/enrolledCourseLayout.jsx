...
const EnrolledCourseLayout = ({ children }) => {
      ...
      {isLoading ? (
        <>
          <div className='flex flex-col px-5'>
            ...
            <div className="mt-3 w-full h-12 rounded-md bg-neutral-50 animate-pulse" />
            <div className="mt-6 w-full h-40 rounded-md bg-neutral-50 animate-pulse" />
            <div className="mt-6 w-full h-40 rounded-md bg-neutral-50 animate-pulse" />
            <div className="mt-6 w-full h-40 rounded-md bg-neutral-50 animate-pulse" />
            <div className="mt-6 w-full h-40 rounded-md bg-neutral-50 animate-pulse" />
          </div>
        ...
        <>
          <nav className="z-50">
            <section className="fixed top-0 w-full h-14">
              <div className="p-5 bg-white z-50 flex items-center gap-5">
                <div
                  onClick={() => navigate(-1)}
                  className="p-2 rounded-md bg-white flex items-center justify-center border border-neutral-200 shadow-sm"
                >
          ...
          <section className="mt-32 px-5 py-3">{children}</section>
        </>
      )}
    </main>
  );
