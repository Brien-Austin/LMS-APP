...
import { emailSchema, passwordSchema } from "../../../types/auth/userauth";



const InstructorRegister = ({ setAuthState }) => {
  ...
  return (
    <section className="flex-1">
      ...
      <form
        ...
        className="flex flex-col w-4/5 lg:px-10 sm:px-2 mx-auto space-y-2"
      >
        <input
          id="email"
      ...
      <p className="text-center mt-4">
        ...
        <span
          onClick={handleLogin}
          className="underline decoration-purple-600 text-purple-600 cursor-pointer"
        >
          Login
        </span>
      </p>
